    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <!-- <app-blue v-if="selectedComponent == 'appBlue'">Blue Component</app-blue>
                <app-green v-if="selectedComponent == 'appGreen'">Green Component</app-green>
                <app-red v-if="selectedComponent == 'appRed'">Red Component</app-red> -->
            </div>
        </div>
    </div>
</template>
